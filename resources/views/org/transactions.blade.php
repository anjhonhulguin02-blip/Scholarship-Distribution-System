...
<head>
    <meta charset="utf-8">
    <title>Transactions &amp; Disbursement &mdash; Block Scholar</title>
    <meta content="width=device-width, initial-scale=1.0" name="viewport">
    <meta name="robots" content="noindex, nofollow">
    <meta name="description" content="Manage cash-in and disbursement transactions on Block Scholar.">
                                                    ...
                                                    <tr class="align-middle">
                                                        ...
                                                        <td class="text-center">
                                                            ...
                                                            @if ($item->transactionHash)
                                                                @if ($item->chainVerified)
                                                                    <br><span class="badge badge-success" title="{{ $item->chainVerificationNote }}">Verified on-chain</span>
                                                                @else
                                                                    <br><span class="badge badge-secondary" title="{{ $item->chainVerificationNote }}">Not verified</span>
                                                                @endif
                                                            @endif
                                                        </td>
                                                        <td>
