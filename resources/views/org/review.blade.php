...
<head>
    <meta charset="utf-8">
    <title>Review Applicant &mdash; Block Scholar</title>
    <meta content="width=device-width, initial-scale=1.0" name="viewport">
    <meta name="robots" content="noindex, nofollow">
    <meta name="description" content="Review an individual scholarship applicant on Block Scholar.">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <embed style="height: 600px;" class="embed-responsive mt-2" id="pdfViewer"
                                        src="/files/applications/{{ $data['applicationID'] }}"
