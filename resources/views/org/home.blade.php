...
<head>
    <meta charset="utf-8">
    <title>Organization Dashboard &mdash; Block Scholar</title>
    <meta content="width=device-width, initial-scale=1.0" name="viewport">
    <meta name="robots" content="noindex, nofollow">
    <meta name="description" content="Organization/Provider dashboard on Block Scholar.">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="card bg-white">
                        <div class="card-body">
                            ...
                            <p>
                                When you disburse approved funds, the transfer is sent on the Ethereum Sepolia
                                testnet and checked against the network before being marked verified. Applicant
                                records stay off-chain &mdash; see <a href="/how-it-works#disbursement">how it works</a>.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4">
                    <div class="card bg-white">
                        <div class="card-body">
                            <h4>Provider Funding &amp; Disbursement</h4>
                            <p>
                                Fund your own scholarship balance and disburse approved awards directly to a
                                student's payment address from your connected wallet.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="row mt-3 ">
                ...
                <div class="col-lg-4">
                    <div class="card bg-white">
                        <div class="card-body">
                            <h4>Applicant Data Kept Off-Chain</h4>
                            <p>
