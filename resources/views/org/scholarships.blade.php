...
<head>
    <meta charset="utf-8">
    <title>Create a Scholarship &mdash; Block Scholar</title>
    <meta content="width=device-width, initial-scale=1.0" name="viewport">
    <meta name="robots" content="noindex, nofollow">
    <meta name="description" content="List a new scholarship on Block Scholar.">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row mt-4">
                                    ...
                                    <div class="col-lg-4">
                                        <label class="text-dark" for="applicationDeadline">Application Deadline
                                            (optional):</label>
                                        <input type="date" name="applicationDeadline" id="applicationDeadline"
                                            min="{{ now()->format('Y-m-d') }}" class="form-control">
                                        <small class="form-text text-muted">Shown on the public scholarship
                                            catalog. Leave blank for rolling admissions.</small>
                                    </div>
                                </div>
                                <div class="row mt-4">
                                    <div class="col-lg-12">
