...
<head>
    <meta charset="utf-8">
    <title>My Details &mdash; Block Scholar</title>
    <meta content="width=device-width, initial-scale=1.0" name="viewport">
    <meta name="robots" content="noindex, nofollow">
    <meta name="description" content="Manage your student profile details on Block Scholar.">
                                ...
                                <div class="row">
                                    <div class="col-lg-5 mx-auto bg-grey" style="height: 250px;">
                                        ...
                                        @if ($student && $student['profile'])
                                            <img height="250px" src="/files/profiles/{{ $student['id'] }}"
                                                alt="Your uploaded profile photo">
                                        @else
                                            <img class="mx-auto" src="" id="imgProfile" height="250px"
                                                alt="No profile photo uploaded yet">
                                        @endif
                                    </div>
                                </div>
                                <div class="row mt-2">
